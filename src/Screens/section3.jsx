                ...
                <div className="row">
                    ...
                    <div className="container">
                        <div className="col-sm-12 col-md-6 two-left-div">
                            ...
                            <p className="text">Cloud is just too far, unreliable, & slow for real-time analysis and
                                action. Use local intelligence at the edge for vision, sound and sensor data:</p>
                            ...
                            <div className="btn-top-space">
                                <a href="#contact" className="btn btn-1 tryBtn">Learn more </a>
                            </div>
                        </div>
                    </div>
                </div>
